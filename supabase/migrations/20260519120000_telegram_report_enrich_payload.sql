-- =========================================================
-- Arricchisce il payload Telegram per repeater_reports
-- con i dati del ripetitore (callsign, frequenza, accessi).
-- Per repeater_submissions resta invariato: i campi sono
-- già tutti nella riga inserita.
-- =========================================================
...
begin
  ...
  -- Per i report, allega i dati del ripetitore referenziato
