...
posizione approssimata alla città che RepeaterBook pubblica per i ponti privati.

I dati di accesso sono invece parziali, perché il dump USA di RepeaterBook non
